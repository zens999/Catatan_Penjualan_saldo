<nav x-data="{ open: false, showNotifications: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
                ...
                <div x-data="{ showNotifications: false }" class="relative">
                    ...
                    <div x-show="showNotifications" @click.away="showNotifications = false"
                        ...
                        <div class="py-2">
                            ...
                            @empty
                                <div class="px-4 py-2 text-sm text-gray-500 dark:text-gray-600">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('setor.index')" :active="request()->routeIs('setor.index')">
                {{ __('Setor') }}
            </x-responsive-nav-link>
            @auth
                @if (auth()->user()->role == 'admin')
                    <x-responsive-nav-link :href="route('admin.transaksilogs.index')" :active="request()->routeIs('admin.transaksilogs.index')">
                        {{ __('Karyawan') }}
                    </x-responsive-nav-link>
